type ChangeTrainIconProps = {
  className?: string
}

export default function ChangeTrainIcon({ className }: ChangeTrainIconProps) {
  return (
    <svg width="76" height="60" viewBox="0 0 76 60" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
